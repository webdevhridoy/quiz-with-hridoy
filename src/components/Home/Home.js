        ...
        <div>
            <div className='bg-violet-700 flex justify-center items-center py-40'>
                <div>
                    ...
                    <Link className='bg-violet-700 px-10 py-3 rounded-2xl text-white hover:bg-white hover:text-violet-700 border-2 duration-300 mt-6 inline-block' to='/home'><button>Check out Quizs</button></Link>
                </div>
            </div>
